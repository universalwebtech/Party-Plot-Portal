  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="box">
		...
		@if (!empty($crud->filters) AND $crud->filters->count())
...
@section('bootstrap-tour')
<script>
// Instance the tour
var stepsList = [
{
element: "#uploadContactButton", // string (jQuery selector) - html element next to which the step popover should be shown
placement: 'right',
title: "Upload Contacts", // string - title of the popover
content: "Please click here to upload contacts in bulk using an excel file", // string - content of the popover
}
];
